...
const QUICK_QUESTIONS = [
      { label: '💰 平台收费吗？', answer: '平台大部分功能免费！登录就能用全部25关靶场、知识库、面试搭子、面试训练场。唯一付费的是一对一职业规划咨询（29.9元），学长亲自帮你做职业评估和规划建议。' },
      { label: '📊 职业咨询怎么预约？', answer: '一对一职业规划咨询是1V1人工服务（29.9元）。付款后学长会在48小时内联系你，根据你的情况做职业评估和规划建议。在「职业诊断」页面点「预约1v1咨询」即可。' },
      { label: '🚀 零基础能做什么？', answer: '可以从"AI安全测试员"或"合规助理"入门！0经验也能做prompt评测、内容审核、等保材料准备等工作。先去靶场练基础篇，再看"转型入门"视频频道！' },
  ...
  { label: '📚 从哪开始学？', answer: '推荐路径：先去「知识库」系统化学习基础理论 → 再进「靶场」边玩边练 → 最后用「面试搭子」结合简历练面试真题。如果零基础也不用担心，平台专门为在校生设计！' },
  { label: '💡 Shieldy 是谁？', answer: '我是 AIShield Lab 的 AI 助教 Shieldy 🤖 专门帮你解答 AI 安全学习中的各种问题。学习问题问我，职业规划找学长 → 点击导航栏「联系学长」可以加微信预约 1 对 1 咨询哦！' },
]
