...
const QUICK_QUESTIONS = [
      { label: '💰 平台收费吗？', answer: '免费体验：前5关靶场+知识库预览+视频预览+面试搭子每天3次。会员订阅：¥19.9/月、¥99/年、¥299终身买断，解锁全部25关靶场+全知识库+全视频+面试搭子无限次。1v1服务（职业规划¥399、简历精修¥299、学长模拟面¥599）加微信私域成交。' },
      { label: '📊 职业咨询怎么预约？', answer: '1v1职业规划是学长亲自做的人工服务，¥399含2次。不在网站直接付款——点击导航栏「联系学长」加微信，跟学长沟通需求后微信转账，学长48小时内联系你做职业评估和规划。' },
      { label: '🚀 零基础能做什么？', answer: '可以从"AI安全测试员"或"合规助理"入门！0经验也能做prompt评测、内容审核、等保材料准备等工作。先去靶场练前5关（免费），再考虑买会员解锁全部！' },
  ...
  { label: '🎮 靶场怎么玩？', answer: '点击导航栏的「靶场」即可进入！目前有 25 关实战关卡，覆盖 Prompt 注入、对抗攻击、数据泄露等方向。前5关免费体验，后续关卡需购买会员解锁（¥19.9/月起）。浏览器直接开练，不用装任何环境～' },
  { label: '📚 从哪开始学？', answer: '推荐路径：先去「知识库」系统化学习基础理论 → 再进「靶场」边玩边练 → 最后用「面试搭子」结合简历练面试真题。前5关靶场免费，零基础也能上手！' },
  { label: '💡 Shieldy 是谁？', answer: '我是 AIShield Lab 的 AI 助教 Shieldy 🤖 专门帮你解答 AI 安全学习中的各种问题。学习问题问我，1v1职业规划找学长 → 点击导航栏「联系学长」加微信咨询！' },
]
