...
const QUICK_QUESTIONS = [
      { label: '💰 平台收费吗？', answer: '免费体验：前5关靶场+知识库预览+视频预览+面试搭子每天3次。会员订阅：¥19.9/月、¥99/年、¥299终身买断，解锁全部25关靶场+全知识库+全视频+面试搭子无限次。1v1定制服务（职业规划、简历精修、模拟面试等）加微信私域咨询，学长亲自服务。' },
      { label: '📊 职业咨询怎么预约？', answer: '1v1职业规划是学长亲自做的人工服务，不在网站直接付款。点击导航栏「联系学长」加微信，跟学长沟通需求后即可安排。' },
