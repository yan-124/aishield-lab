...
const PLANS = [
  {
    ...
    yearlyPrice: null,
    monthlyCredits: 50,
    features: ['前5关靶场', '知识库预览（前300字）', '视频预览（前3分钟）', '面试搭子每天3次', 'Shieldy AI助教'],
    isCurrent: true,
  },
  {
    id: 'monthly',
    ...
    yearlyPrice: null,
    monthlyCredits: 500,
    features: ['全部25关靶场', '全知识库', '全视频', '面试搭子无限次', '跑马灯不限'],
    isCurrent: false,
  },
  {
    id: 'annual',
    ...
    yearlyDiscount: 58,
    monthlyCredits: 500,
    features: ['月度会员全部功能', '月均仅¥8.25', '持续更新', '优先客服'],
    isCurrent: false,
  },
  {
    id: 'lifetime',
    ...
    yearlyDiscount: null,
    monthlyCredits: 2000,
    features: ['年度会员全部功能', '一次买断永久使用', '持续更新', '新关卡优先体验', '专属社群'],
    isCurrent: false,
  },
]
